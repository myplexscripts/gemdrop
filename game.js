(() => {
  ...
  const tiers = [
    {name:'Quartz', cut:'Rectangular', cutKey:'rose', reactiveCut:'rectangular', r:49, score:1, color:'#D7EBF2', accent:'#EDF6F9', dark:'#859296'},
    ...
    {name:'Sunstone', cut:'Emerald Stepcut', cutKey:'cushion', reactiveCut:'emerald_stepcut', r:57, score:6, color:'#E67A45', accent:'#F4C3AB', dark:'#8F4C2B'},
    {name:'Amethyst', cut:'Rectangular Brilliant', cutKey:'emerald', reactiveCut:'rectangular_brilliant', r:61, score:10, color:'#A968E5', accent:'#D8BBF3', dark:'#69408E'},
    {name:'Peridot', cut:'Heart', cutKey:'princess', reactiveCut:'heart', r:65, score:15, color:'#99D64D', accent:'#D1EDAF', dark:'#5F8530'},
    {name:'Garnet', cut:'Tanzanite', cutKey:'radiant', reactiveCut:'tanzanite', r:69, score:22, color:'#B33149', accent:'#DDA2AD', dark:'#6F1E2D'},
    {name:'Topaz', cut:'Rectangular', cutKey:'square', reactiveCut:'rectangular', r:74, score:30, color:'#D7902F', accent:'#EDCDA1', dark:'#85591D'},
    {name:'Moonstone', cut:'Circular Starcut', cutKey:'french', reactiveCut:'circular_starcut', r:79, score:40, color:'#B9C9F2', accent:'#E0E7F9', dark:'#737D96'},
    {name:'Zircon', cut:'Emerald Stepcut', cutKey:'oval', reactiveCut:'emerald_stepcut', r:84, score:52, color:'#42C7E8', accent:'#AAE6F5', dark:'#297B90'},
    {name:'Morganite', cut:'Rectangular Brilliant', cutKey:'asscher', reactiveCut:'rectangular_brilliant', r:89, score:66, color:'#F5B3C8', accent:'#FADDE6', dark:'#986F7C'},
    {name:'Aquamarine', cut:'Heart', cutKey:'pear', reactiveCut:'heart', r:95, score:82, color:'#63E3C4', accent:'#B9F2E4', dark:'#3D8D7A'},
    {name:'Tourmaline', cut:'Tanzanite', cutKey:'octagon', reactiveCut:'tanzanite', r:101, score:100, color:'#C447B6', accent:'#E4ACDE', dark:'#7A2C71'},
    {name:'Tanzanite', cut:'Rectangular', cutKey:'octagon', reactiveCut:'rectangular', r:108, score:122, color:'#4F54D9', accent:'#B0B2EE', dark:'#313487'},
    {name:'Spinel', cut:'Circular Starcut', cutKey:'rectangle', reactiveCut:'circular_starcut', r:115, score:148, color:'#FF4F87', accent:'#FFB0C9', dark:'#9E3154'},
    {name:'Sapphire', cut:'Emerald Stepcut', cutKey:'step', reactiveCut:'emerald_stepcut', r:123, score:178, color:'#2D63D6', accent:'#A0B9ED', dark:'#1C3D85'},
    {name:'Emerald', cut:'Rectangular Brilliant', cutKey:'scissor', reactiveCut:'rectangular_brilliant', r:132, score:212, color:'#18B56A', accent:'#97DEBC', dark:'#0F7042'},
    {name:'Ruby', cut:'Heart', cutKey:'pendeloque', reactiveCut:'heart', r:141, score:250, color:'#E12F4F', accent:'#F2A1B0', dark:'#8C1D31'},
    {name:'Alexandrite', cut:'Tanzanite', cutKey:'trapeze', reactiveCut:'tanzanite', r:150, score:292, color:'#47B38E', accent:'#ACDDCC', dark:'#2C6F58'},
    {name:'Starstone', cut:'Rectangular', cutKey:'navette', reactiveCut:'rectangular', r:160, score:340, color:'#9B6BFF', accent:'#D2BCFF', dark:'#60429E'},
  ...
  class GameScene extends Phaser.Scene {
    ...
    renderCollection() {
      ...
      tiers.forEach((t,tier)=>{
        ...
        card.style.setProperty('--gem-color',t.color);
        card.style.setProperty('--gem-accent',t.accent);
        card.style.setProperty('--gem-dark',t.dark);
        card.setAttribute(
          'aria-label',
          unlocked
            ? t.name+', value 
        ...
        card.append(tierBadge,art,meta);
  ...
  new Phaser.Game(config);
        ...
        tierBadge.className='gem-card__tier';
        tierBadge.textContent=String(tier+1).padStart(2,'0');
